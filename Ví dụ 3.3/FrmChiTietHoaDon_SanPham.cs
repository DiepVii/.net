...
{
    public partial class FrmChiTietHoaDon_SanPham : Form
    {
        int tong;
        // Chuỗi kết nối
        ...
        public FrmChiTietHoaDon_SanPham()
        {
            InitializeComponent();
        }
        ...
        private void FrmChiTietHoaDon_SanPham_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Vận chuyển dữ liệu vào DataTable dtKhachHang
                daChiTietHoaDon = new SqlDataAdapter("SELECT * FROM ChiTietHoaDon where MaSP='" + MaSP + "'", conn);
                dtChiTietHoaDon = new DataTable();
                dtChiTietHoaDon.Clear();
                daChiTietHoaDon.Fill(dtChiTietHoaDon);
                (dgvChiTietHoaDon.Columns["MaHD"] as
