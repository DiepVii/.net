...
{
    public partial class FrmHoaDon_KhachHang : Form
    {
        int tong;
        // Chuỗi kết nối
        ...
        void LoadData()
        {
            try
            {
                ...
                this.cbKhachHang.DisplayMember = "TenCty";
        ...
        private void FrmHoaDon_KhachHang_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String MaTP = cbKhachHang.SelectedValue.ToString();
                // Vận chuyển dữ liệu vào DataTable dtKhachHang
                daHoaDon = new SqlDataAdapter("SELECT * FROM HoaDon where MaKH='"+MaTP+"'", conn);
                dtHoaDon = new DataTable();
                dtHoaDon.Clear();
                daHoaDon.Fill(dtHoaDon);
                // Đưa dữ liệu lên DataGridView 
